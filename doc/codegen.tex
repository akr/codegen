...
\begin{align*}
  K &= [] \\
    ...
    &\bnfor \letin{x}{K:T}{t} \\
    &\bnfor \letin{x}{t:T}{K} \\
    &\bnfor \omatch{K}{\repop{C\:\rep{x{:}T}\Rightarrow u}{|}} \\
    &\bnfor \omatch{t}{\repopi{(C_l\:\rep{x_l{:}T_l}\Rightarrow u_l)}{|}{1\leq l < i} | (C_i\:\rep{x_i{:}T_i}\Rightarrow K) | \repopi{(C_l\:\rep{x_l{:}T_l}\Rightarrow u_l)}{|}{i < l \leq h}  } \\
    &\bnfor \ofix{\repopi{(f_l/k_l{:}T_l:=t_l)}{\kwwith}{1\leq l < i} (f_i/k_i{:}T_i:=K) \repopi{(f_l/k_l{:}T_l:=t_l)}{\kwwith}{i < l \leq h}}{f_j}
\end{align*}
