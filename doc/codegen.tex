...
\begin{align*}
  ...
  &\A{K}{x}{x_1\dots x_n} =
    ...
    && \begin{aligned}[t] & (n > 0) \wedge \text{$x$ is bounded by a fixpoint} \wedge \mbox{} \\ & x \in \tr \end{aligned} \\
  &\A{K}{x}{x_1\dots x_n} = K(\dq{x\ttparen{y_1,\dots,y_o,x_1,\dots, x_n}})
    && \begin{aligned}[t] & (n > 0) \wedge \text{$x$ is bounded by a fixpoint} \wedge \mbox{} \\ & x \not\in \tr \end{aligned} \\
...
\begin{align*}
  ...
  &\begin{cases}
    ...
    \end{aligned} &
      \begin{aligned}[t]
        & (t = \fix{f_i}{t_i}{i=1\dots h}{f_j}) \wedge \mbox{} \\
    ...
    \end{aligned} &
      \begin{aligned}[t]
        ...
        & \neg \bigl((n = \NA_t) \wedge \bigl(\textstyle\bigcup_{i=1}^h N_i \cap \{f_1,\dots, f_h\} = \varnothing\bigr)\bigr) \\
        & \text{where}\quad (R_i, N_i, T_i) = \RNT{t_i}{\NA_{t_i}}
      \end{aligned}
  \end{cases}
\end{align*}
