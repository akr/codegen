...
\[
  ...
  \begin{cases}
    ...
    \begin{aligned}[t]
      (&\cv{t_1}{x_1\ldots x_n}{V;M_1};\dotsb; \\
...
\begin{align*}
  ...
  &\A{K}{x}{x_1\ldots x_n} = K(\dq{x\ttparen{y_1,\dotsc,y_o,x_1,\dotsc, x_n}})
    && \begin{aligned}[t] & (n > 0) \wedge \text{$x$ is bounded by a fixpoint} \wedge {} \\ & x \not\in \tr \end{aligned} \\
  &\A{K}{c}{x_1\ldots x_n} = K(\dq{c\ttparen{x_1,\dotsc, x_n}})                                   && n \geq 0 \\
  &\A{K}{C}{x_1\ldots x_n} = K(\dq{C\ttparen{x_1,\dotsc, x_n}})                                   && n \geq 0 \\
  ...
  &\A{K}{\fix{f_i}{t_i}{i=1\ldots h}{f_j}}{x_1\ldots x_n} =                   && f_j \in \tr \\
     & \quad\begin{alignedat}[t]{2}
       \text{``} & \passign(\fvars{t_j}, x_1\ldots x_n) \\
...
\begin{align*}
  ...
  &\B{K}{c}{x_1\ldots x_n} = K(\dq{c\ttparen{x_1,\dotsc, x_n}})                                   && n \geq 0 \\
  &\B{K}{C}{x_1\ldots x_n} = K(\dq{C\ttparen{x_1,\dotsc, x_n}})                                   && n \geq 0 \\
  ...
  &\B{K}{\fix{f_i}{t_i}{i=1\ldots h}{f_j}}{x_1\ldots x_n} =       \\
     & \quad\begin{alignedat}{2}
       \text{``} & {\passign(\fvars{t_j}, x_1\ldots x_n)} \\
                 & {\genbodyb{K}{\fix{f_i}{t_i}{i=1\ldots h}{f_j}}} \text{''}
       \end{alignedat}
\end{align*}
...
\begin{align*}
  ...
  &\begin{cases}
    ...
    \end{aligned} &
      \begin{aligned}[t]
        & (t = \fix{f_i}{t_i}{i=1\ldots h}{f_j}) \wedge {} \\
    ...
    \end{aligned} &
      \begin{aligned}[t]
        & (t = \fix{f_i}{t_i}{i=1\ldots h}{f_j}) \wedge \quad \text{(real function, maybe closure)} \\
...
\begin{align*}
  ...
  & x_{01}\:\tteq\:\ttparen{\ttparen{\kwstruct\:\mathtt{arg\_}c\:\ttstar}\mathtt{arg}}\texttt{->}\mathtt{arg}1\ttsemi \ldots\ttsemi\:x_{0m_0}\:\tteq\:\ttparen{\ttparen{\kwstruct\:\mathtt{arg\_}c\:\ttstar}\mathtt{arg}}\texttt{->}\mathtt{arg}m_0\ttsemi \text{''}
\end{align*}
\[ \text{where} \quad
  \begin{aligned}[t]
