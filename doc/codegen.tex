...
\newcommand{\us}{\textscale{.5}{\textunderscore}}
  ...
  \text{verify-apparg}:
    \dfrac{
      \begin{aligned}
        & E[\Gamma] \vdash x \not\equiv x' \\
        & E[\Gamma] \vdash p : x = x' \\
        & E[\Gamma] \vdash q : t\: x\: \mathit{args} = t'\: x\: \mathit{args}'
      \end{aligned}
    }{
      \kwrew\: p\: \kwin\: q : t\: x\: \mathit{args} = t'\: x'\: \mathit{args}'
    } \\
    \quad \mbox{where} \quad \kwrew\: p\: \kwin\: q := \mathsf{eq\_ind}\: x\: (\lam{y}{t\: y\: \mathit{args}})\: q\: x'\: p \\
    \quad \mbox{Note:}~
      \begin{minipage}[t]{0.8\columnwidth}
