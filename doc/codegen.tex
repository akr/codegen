...
\begin{gather*}
  \text{zeta-arg:}~
    \dfrac
    {
      ...
      E[\Gamma] \vdash
      t\:\overline{x}\:u\:\overline{a}
      \reltri
      \letin{y}{u:U}{t\:\overline{x}\:y\:\overline{a}}
    } \breakrule
  \text{zeta-item:}~
    \dfrac
    {
      ...
      E[\Gamma] \vdash
        \omatch{u}{\overline{C\:\overline{x} \Rightarrow t}}
        \reltri
        \letin{y}{u:U}{\omatch{y}{\overline{C\:\overline{x} \Rightarrow t}}}
    }
\end{gather*}
...
\begin{gather*}
  ...
  \text{iota-match-var:}~
    \dfrac
    {
      (v:=C_j\:\overline{y}\:\overline{z}:T) \in \Gamma \quad
      |y|=\NP_T
    }{
      E[\Gamma] \vdash
      \omatch{v}{\overline{C\:\overline{x}\Rightarrow t}}
      \reltri
...
\begin{align*}
  \tD =&\ \lamT{x}{\fbox{$T$}}{\tD'} & \leftarrow \\
      |&\ \ofix{\overline{f/k{:}\fbox{$T$}:=\tD}}{f_j} & \leftarrow \\
  \tD' =&\ \tD \\
       |&\ \tL & \text{the type of $\tL$ is an inductive type} \\
  ...
  \tE =&\ x ~|~ c ~|~ C ~|~ T \\
    |&\ \tF\:\rep{x} & \text{$0 < |x|$} \\
    |&\ \tD \\
  \tF =&\ x ~|~ c ~|~ C ~|~ \ofix{\overline{f/k{:}\fbox{$T$}:=\tD}}{f_j} & \leftarrow
\end{align*}
