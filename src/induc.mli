...
val command_ind_type2 : Constrexpr.constr_expr -> State.c_typedata option * string option -> State.cstr_config list -> unit
...
val command_ind_match :
  ...
  string option -> State.cstr_config list -> unit
